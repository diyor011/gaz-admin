...
export default function EditGenderModal({ open, onClose, onSubmit, form, setForm }) {
    if (!open) return null;
            ...
            <div className="bg-base-100 w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="bg-info px-6 py-5 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-base-100">Gender tengligi hujjati tahrirlash</h2>
                    </div>
                    <button
                        onClick={onClose}
