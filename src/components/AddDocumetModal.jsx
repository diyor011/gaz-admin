        ...
        <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Название документа (RU)"
                name="titleRu"
                value={form.titleRu}
                onChange={handleChange}
              />
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-base-content uppercase tracking-wide">
                Qaror yoki farmon raqami{" "}
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Карор ёки фармон раками  (Уз)"
                name="decreeUz"
                value={form.decreeUz}
                onChange={handleChange}
              />
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Номер решения или постановления (RU)"
                name="decreeRu"
                value={form.decreeRu}
                onChange={handleChange}
              />
