...
export default function AddDepartamentModal({
  open,
  onClose,
  onSubmit,
  form,
        ...
        <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Название отдела (RU)"
                name="titleRu"
                value={form.titleRu}
                onChange={handleChange}
              />
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Количество сотрудников (RU)"
                name="employeesRu"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <input
                className="px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Начальник отдела (RU)"
                name="leaderRu"
                value={form.leaderRu}
                onChange={handleChange}
              />
