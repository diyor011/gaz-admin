...
export default function AddLeaderModal({ open, onClose, onSubmit, form, setForm }) {
    if (!open) return null;
            ...
            <div className="bg-base-100 w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-2 mb-3">
                            <Award size={18} className="text-accent" />
                            <h3 className="text-sm font-semibold text-base-content uppercase tracking-wide">Malumoti</h3>
                        </div>
                        <div className="flex  justify-around w-full gap-4">
                            <input
                                className="px-4 w-full py-3 border-2 border-base-200 rounded-lg focus:border-amber-500 focus:outline-none transition-colors duration-200 hover:border-base-content"
                                placeholder="Telefon "
                                name="phone"
                                value={form.phone}
                                onChange={handleChange}
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-2 mb-3">
                            <Award size={18} className="text-accent" />
                            <h3 className="text-sm font-semibold text-base-content uppercase tracking-wide">islash grafig</h3>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            <input
                                className="px-4 py-3 border-2 border-base-200 rounded-lg focus:border-amber-500 focus:outline-none transition-colors duration-200 hover:border-base-content"
                                placeholder="Ish Vaqti boshlanishi (UZ)"
                                name="workHoursStart"
                            ...
                            <input
                                className="px-4 py-3 border-2 border-base-200 rounded-lg focus:border-amber-500 focus:outline-none transition-colors duration-200 hover:border-base-content"
                                placeholder="Ish Vaqti tugashi (RU)"
                                name="workHoursEnd"
