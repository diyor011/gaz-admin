        ...
        <div className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <input
                type="text"
                className=" px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Режалар Квартоли (УЗ)"
                name="title_uz"
                value={form.title_uz || ""}
                onChange={handleChange}
              />
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <select
                ...
                onChange={handleChange}
                className="px-4 py-3 border-2 text-info border-info hover:border-warning hover:text-warning focus:text-success rounded-lg focus:border-success outline-none transition-colors duration"
              >
                <option value="">Режалар Тури (УЗ)</option>
                <option value="Reja">Режа</option>
                <option value="Hisobot">Хисобот</option>
              </select>
              ...
              <select
                ...
                className="px-4 py-3 border-2 text-info border-info hover:border-warning hover:text-warning focus:text-success rounded-lg focus:border-success outline-none transition-colors duration"
              >
                <option value="">Тип планов (RU)</option>
              ...
              <select
                ...
                className="px-4 py-3 border-2 text-info border-info hover:border-warning hover:text-warning focus:text-success rounded-lg focus:border-success outline-none transition-colors duration"
              >
                <option value="">Rejalar turi (OZ)</option>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <textarea
                className="w-full  px-4 py-3 border-2  text-info border-info hover:border-warning hover:text-warning focus:text-success -200 rounded-lg focus:border-success outline-none transition-colors duration"
                placeholder="Ежемесячные планы (RU)"
                name="description_ru"
