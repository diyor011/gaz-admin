    ...
    try {
      ...
      if (form.image) {
        ...
        const res = await fetch(
          `https://uzneftegaz-backend-production.up.railway.app/api/honorary/update/${form._id}`,
          {
            method: "PUT",
            headers: {
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              >
                <Image
                  size={20}
                  className="text-gray-400 group-hover:text-error transition-colors"
                />
                <span className="text-gray-600 group-hover:text-error font-medium">
                  {form.image
                    ? form.image.name
                    : "Yangi rasm tanlash uchun bosing"}
                </span>
              </label>
            </div>
          </div>
