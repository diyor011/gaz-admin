...
const Documents = () => {
  ...
  const GetDocuments = async () => {
    try {
      const response = await fetch('https://uzbekneftegaz-backend-production.up.railway.app/api/yoshlarSiyosati')
  ...
  const createDocuments = async (formData) => {
    try {
      ...
      const response = await fetch(
        "https://uzbekneftegaz-backend-production.up.railway.app/api/yoshlarSiyosati",
        {
          method: "POST",
          headers: {
  ...
  const updateDocuments = async (id, formData) => {
    try {
      ...
      try {
        const response = await fetch(`https://uzbekneftegaz-backend-production.up.railway.app/api/yoshlarSiyosati/${id}`, {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const deleteDocuments = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `https://uzbekneftegaz-backend-production.up.railway.app/api/yoshlarSiyosati/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
